...
{
    /// <inheritdoc />
    public partial class addingHotelroomstable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    priceonseason = table.Column<double>(type: "float", nullable: false),
                    priceoffseason = table.Column<double>(type: "float", nullable: false),
                    capacity = table.Column<int>(type: "int", nullable: false),
                    extrachargeperperson = table.Column<double>(type: "float", nullable: false),
